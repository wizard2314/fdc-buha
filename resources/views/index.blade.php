...
@section('content')
    ...
    <div class="w-full max-w-screen-2xl mx-auto p-3 md:p-16">
        <div class="flex flex-col-reverse md:flex-row items-center">
            <div class="w-full md:w-1/5 px-2 md:px-6 py-3 md:py-5">
                <div class="flex flex-row md:flex-col space-x-4 md:space-y-4 px-4">
                    <div class="h-20 md:h-28 flex flex-col ">
                        <h1 class="text-3xl md:text-5xl font-mono text-center md:text-left font-extrabold">200+</h1>
                        <p class="text-center md:text-left text-lg md:text-2xl font-mono font-thin">Students</p>
                    </div>
                    <div class="h-20 md:h-28 flex flex-col ">
                        <h1 class="text-3xl md:text-5xl font-mono text-center md:text-left font-extrabold">77+</h1>
                        <p class="text-center md:text-left text-lg md:text-2xl font-mono font-thin">Courses</p>
                    </div>
                    <div class="h-20 md:h-28 flex flex-col ">
                        <h1 class="text-3xl md:text-5xl font-mono text-center md:text-left font-extrabold">70+</h1>
                        <p class="text-center md:text-left text-lg md:text-2xl font-mono font-thin">Staff</p>
                    </div>
                </div>
            </div>
            <div class="w-full md:w-4/5 ml-4 px-2 md:px-5">
    ...
    <div class="p-6 md:p-16 bg-gray-100 w-full max-w-screen-2xl">
        ...
        <div class="flex flex-col md:flex-row">
            ...
            <div class="text-justify font-light text-gray-500 w-full md:w-3/5 px-3 md:px-5">
