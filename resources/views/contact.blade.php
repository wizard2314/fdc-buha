...
@section('content')
    <div class="flex flex-col md:flex-row md:p-20 p-6">
        <!-- Map and Contact Information -->
        <div class="w-full md:w-1/2 text-center bg-white">
            <h2 class="md:text-3xl text-xl font-semibold font-sans uppercase mb-4">Contact Information</h2>
            <p class="mb-2"><span class="md:text-2xl text-lg font-sans">Email </span> <br> <a href="mailto:buhangijafdc@moe.go.tz" class="text-gray-600 md:text-md text-sm">buhangijafdc@moe.go.tz</a></p>
            <p class="mb-2"><span class="md:text-2xl text-lg font-sans">Phone </span> <br> <a href="tel:+255746764547" class="text-gray-600 md:text-md text-sm">+255746764547</a></p>
            <p class="mb-2"><span class="md:text-2xl text-lg font-sans">Address</span> <br><a href="" class="text-gray-600 md:text-md text-sm">Buhangija, Shinyanga</a></p>
        ...
        <!-- Contact Form -->
        <div class="w-full md:w-1/2 p-8 bg-white mt-4 md:mt-0">
